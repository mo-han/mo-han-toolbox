...
def inplace_pattern_rename(src_path: str, pattern: str, repl: str, *,
    ...
    if only_basename:
        ...
        dst_path = os.path.join(parent,
                                re.simple_replace(src_path, pattern, repl, use_regex=regex,
                                                                         ignore_case=ignore_case))
    else:
        dst_path = re.simple_replace(src_path, pattern, repl, use_regex=regex, ignore_case=ignore_case)
    if not dry_run:
